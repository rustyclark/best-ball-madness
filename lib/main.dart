...
class DesignSystemGallery extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayout(
      appBar: AppBar(title: const Text('BBM DESIGN SYSTEM')),
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.xs),
            Text(
              'Outfit Body Large (Primary)',
              style: theme.textTheme.bodyLarge,
            ),
            const SizedBox(height: AppSpacing.xs),
            Text(
              'Outfit Body Medium (Secondary)',
            ...
            Row(
              children: [
                Expanded(
                  child: BbmButton(text: 'Primary Button', onPressed: () {}),
                ),
            ...
            Row(
              children: [
                ...
                const SizedBox(width: AppSpacing.md),
                const Expanded(child: BbmButton.text(text: 'Text Link Button')),
              ],
            ),
            const SizedBox(height: AppSpacing.lg),
            ...
            BbmCard(
              ...
              child: BbmEmptyState(
                ...
                action: BbmButton(text: 'Refresh Schedule', onPressed: () {}),
              ),
            ),
