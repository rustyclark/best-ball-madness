...
# Usage: ./trigger_ingest_field.sh [SUPABASE_URL] [SERVICE_ROLE_KEY]
URL="${1:-$SUPABASE_URL}"
...
echo "Triggering ingest-tournament-field on: $URL"
echo "Sending POST request..."

curl -i -X POST "$URL/functions/v1/ingest-tournament-field" \
