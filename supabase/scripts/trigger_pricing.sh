...
# Usage: ./trigger_pricing.sh [SUPABASE_URL] [SERVICE_ROLE_KEY]
URL="${1:-$SUPABASE_URL}"
...
echo "Triggering run-pricing-algorithm on: $URL"
echo "Sending POST request..."

curl -i -X POST "$URL/functions/v1/run-pricing-algorithm" \
